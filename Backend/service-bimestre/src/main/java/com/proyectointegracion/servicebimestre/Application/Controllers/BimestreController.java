package com.proyectointegracion.servicebimestre.Application.Controllers;

import com.proyectointegracion.servicebimestre.Application.Dto.Bimestre.RespuestaBimestre;
import com.proyectointegracion.servicebimestre.Application.Dto.Bimestre.RespuestaListBimestre;
...
import com.proyectointegracion.servicebimestre.Domain.Services.BimestreService;
...
public class BimestreController {
    ...
    public ResponseEntity<List<Bimestre>> getRBimestresPorYear(@PathVariable("idYear") int idYear) {
        List<Bimestre> bimestres = bimestreService.listarBimestrePorYear(idYear);
        return  ResponseEntity.ok(bimestres);
