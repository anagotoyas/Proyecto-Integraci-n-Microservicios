package com.proyectointegracion.servicerol.Application.Controllers;

import com.proyectointegracion.servicerol.Application.Dto.Respuestas.Respuesta;
import com.proyectointegracion.servicerol.Application.Dto.Rol.RespuestaListRol;
import com.proyectointegracion.servicerol.Application.Dto.Rol.RespuestaRol;
import com.proyectointegracion.servicerol.Application.Dto.Usuario.RespuestaListUsuario;
...
import com.proyectointegracion.servicerol.Domain.Services.RolService;
...
public class RolController {
    ...
    public ResponseEntity<Usuario[]> getRegistros(@PathVariable("idRol") int idRol) {
        Usuario[] usuarios = rolService.getUsuariosPoridRol(idRol);
